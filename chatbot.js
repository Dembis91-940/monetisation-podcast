/* Chatbot widget — PodMonétise — v1.0
...
(function () {
  ...
  panel.innerHTML =
    '<div style="background:' + ACCENT + ';color:#fff;padding:14px 16px;display:flex;align-items:center;gap:10px;">' +
      '<div style="width:34px;height:34px;border-radius:50%;background:rgba(255,255,255,.25);display:flex;align-items:center;justify-content:center;font-size:17px;">🎙️</div>' +
  ...
  function askLead(question) {
    ...
    form.innerHTML =
      '<div style="font-size:12px;color:#666;margin-bottom:8px;">Laissez vos coordonnées, on vous répond sous 24 h :</div>' +
